import { renderOpenElevator, renderClosedElevator, renderUpDownButtons } from "../src/functions/renderFunctions.js";
...
test("Should render two buttons inside the up-down button div", () => {
    renderUpDownButtons()
    expect( document.getElementsByClassName('button').length ).toBe(2)
})
